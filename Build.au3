...
Sleep(500)
ControlSend($hWin4, "", "[CLASS:Edit; INSTANCE:2]", "C:\Users\Dank Memes\Documents\Rainmeter\Skins\Roundline\MouseInfo Plugin\bin\x86", 1)
...
ControlClick($hWin4, "", "[CLASS:ToolbarWindow32; INSTANCE:2]", "left", 1, 0, 0)
Sleep(500)
ControlSend($hWin4, "", "[CLASS:Edit; INSTANCE:2]", "C:\Users\Dank Memes\Documents\Rainmeter\Skins\Roundline\MouseInfo Plugin\bin\x64", 1)
ControlSend($hWin4, "", "[CLASS:Edit; INSTANCE:2]", "{ENTER}")
Sleep(500)
ControlSend($hWin4, "", "[CLASS:Edit; INSTANCE:1]", "MouseInfo.dll", 1)
ControlSend($hWin4, "", "[CLASS:Edit; INSTANCE:1]", "{ENTER}")
